    ...
    <div class="fundo-tabela">
        <div class="card-tabela">
            ...
            <table>
                ...
                <tbody>
                    <?php
                    // busca apenas os registros da página atual, usando $inicio e $por_pagina
                    $sql = "SELECT * FROM usuario ORDER BY id LIMIT $inicio, $por_pagina";
            ...
            <div class="paginacao">
                ...
                if ($pagina_atual > 1) {
                    ...
                    echo "<a href='listar_usuarios.php?pagina=$pagina_anterior'>&laquo; Anterior</a>";
                } else {
                ...
                for ($i = 1; $i <= $total_paginas; $i++) {
                    if ($i == $pagina_atual) {
                        ...
                        echo "<a href='listar_usuarios.php?pagina=$i' class='ativo'>$i</a>";
                    } else {
                        // páginas diferentes da atual ficam com link normal
                        echo "<a href='listar_usuarios.php?pagina=$i'>$i</a>";
                    }
                }
                ...
                if ($pagina_atual < $total_paginas) {
                    ...
                    echo "<a href='listar_usuarios.php?pagina=$proxima_pagina'>Próxima &raquo;</a>";
                } else {
