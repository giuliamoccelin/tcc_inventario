...
$sql_total = "SELECT COUNT(*) AS total FROM equipamento";
    ...
    <div class="fundo-tabela">
        <div class="card-tabela">
            <div class="fundo-opções">
                <a href="cadastro_maquina.php">CADASTRAR EQUIPAMENTO</a>
                <a href="escanear_nmap.php">ESCANEAR EQUIPAMENTOS</a>
            </div>
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php
                    include "connect.php";
                    $sql = "SELECT * FROM equipamento ORDER BY id DESC LIMIT $inicio, $por_pagina";
            ...
            <div class="paginacao">
                ...
                if ($pagina_atual > 1) {
                    ...
                    echo "<a href='listar_maquinas.php?pagina=$pagina_anterior'>&laquo; Anterior</a>";
                } else {
                ...
                for ($i = 1; $i <= $total_paginas; $i++) {
                    if ($i == $pagina_atual) {
                        ...
                        echo "<a href='listar_maquinas.php?pagina=$i' class='ativo'>$i</a>";
                    } else {
                        // páginas diferentes da atual ficam com link normal
                        echo "<a href='listar_maquinas.php?pagina=$i'>$i</a>";
                    }
                }
                ...
                if ($pagina_atual < $total_paginas) {
                    ...
                    echo "<a href='listar_maquinas.php?pagina=$proxima_pagina'>Próxima &raquo;</a>";
                } else {
